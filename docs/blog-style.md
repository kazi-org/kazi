...
- **T38.20 — visual assets:** explanatory diagrams in the site's visual language (the
  reconcile loop, the rung ladder, a without/with before-after) plus per-post header
  art — technical diagrams, **not** glossy ad creative. Reuse existing site/README
