...
State of `main`: **841 tests pass** (66 doctests, 775 tests), 18 excluded
(`:nats`/`:graphify` integration tags); `mix format --check-formatted` clean;
`mix compile --warnings-as-errors` clean. E8 is nearly done: T8.1-T8.6 + T8.8
merged (PRs #80/#82/#84/#83/#86/#87/#88). Only **T8.7** (Runtime/CLI wiring) and
then T8.9/T8.10 (verify + docs) remain; T8.7 is now unblocked.
...
- **Wave E8-4 (now, integrate):** T8.7   (Runtime/CLI/authoring/adopt wiring; deps T8.2/T8.4/T8.5/T8.6 -- all done).
